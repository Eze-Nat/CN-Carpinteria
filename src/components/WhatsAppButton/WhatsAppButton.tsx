function WhatsAppButton() {
  const phoneNumber = "5493416878831"; // después ponemos el real
  const message = "Hola CN Carpintería 👋 Me gustaría consultar por muebles a medida.";
  ...
  return (
    ...
    >
      <div className="bg-green-500 hover:bg-green-600 transition-all duration-300 w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110">
        <svg
